                ...
                <div class="col-md-10">
                    <div class="row p-2 bg-white border rounded">
                        <div class="col-md-3 mt-1">
                            <?php echo '<img src=assets/images/sappen/groentensap/' . $producten['image'] . ' alt="geen afbeelding beschikbaar" class="img-fluid" />' ?>
                        </div>
                        ...
                        <div class="align-items-center align-content-center col-md-3  mt-1">
                            ...
                            <h6 class="text-success">Bestel nu morgen in huis</h6>
